...
<html lang="en">
  ...
  <link href="/dist/styles.669fd6e3ad592875b15c.css" rel="stylesheet"></head>
  <body>
    <!-- renders header-->
    <div class="wrapper">
      <div class="content">
  ...
  <div class="row col-12"><a class="header-container__logo col-12 col-sm-6 col-md-8 col-xl-9" href="/" title="InstantCar"><img src="/assets/images/Logo.svg" alt="InstantCar"></a>
    <div class="header-container__phone col-12 col-sm-6 col-md-4 col-xl-3">
      <div class="header-container__phone-title">
        ...
        <!-- pages view router-->
<!-- Main page--><?if ($route == 'main-page') {
  include_once './pages/main-page.php';
  } ?>
<!-- Pages with filter--><?if ($addr[1] == 'search' || ($addr[1] == 'auto' && count($addr) == 2)) {
  include_once './pages/filter.php';
 } ?>
<!-- Detail auto page--><?if ($addr[1] == 'auto' && count($addr) == 3) {
...
<div class="footer">
  ...
  <script type="text/javascript" src="/dist/index.669fd6e3ad592875b15c.js"></script><script type="text/javascript" src="/dist/styles.669fd6e3ad592875b15c.js"></script></body>
</html>